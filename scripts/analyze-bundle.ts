...
const scenarios = [
  {
    name: "FlightClient only (no SQL)",
    includes: [
      "client/flight-client.js",
      "client/create-flight-client.js",
      "client/errors.js",
      "client/ipc.js",
      "client/types.js",
      "gen/arrow/flight/Flight_pb.js",
      "index.js"
    ]
  },
  {
    name: "FlightSqlClient (full)",
    includes: jsFiles.map((f) => f.replace(`${distDir}/`, ""))
  },
  {
    name: "IPC utilities only",
    includes: ["client/ipc.js", "client/types.js", "index.js"]
  }
]
